 ...
 */
public class TestInterceptViewGroup1 extends FrameLayout {

    private static final String TAG = "info";
    protected String NAME = TestInterceptViewGroup1.class.getSimpleName();

    protected Logger mLogger = new Logger(TAG, true);

    public TestInterceptViewGroup1(Context context) {
        super(context);
    }

    public TestInterceptViewGroup1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TestInterceptViewGroup1(Context context, AttributeSet attrs, int defStyleAttr) {
